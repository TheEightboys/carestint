...
const features = [
  {
    ...
    highlights: ['Instant matching', '4 hours average fill time'],
  },
  {
  ...
  },
  {
    ...
    title: 'Secure',
    description: 'Your facility and professionals are protected with strict identity checks, verified licenses, and secure, traceable payments handled through trusted partners.',
    highlights: ['License-verified professionals', 'Compliant, secure payment'],
  },
];
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-16 grid grid-cols-2 gap-4 sm:grid-cols-4 max-w-4xl mx-auto">
            {[
              ...
              { icon: <Zap className="h-5 w-5" />, label: '4 hours', sublabel: 'Avg. fill time' },
            ].map((stat, i) => (
